...
export default function TaskDetailSidebar({ task, open, onClose, onTaskUpdated, onTaskDeleted }) {
  ...
  return (
    <div className="fixed top-0 right-0 h-full w-full max-w-md bg-white shadow-2xl z-50 border-l border-gray-200 flex flex-col">
      <div className="flex justify-between items-center p-6 border-b">
        <h2 className="text-2xl font-bold text-indigo-700">Edit Task</h2>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        <div className="mb-4">
          ...
          <textarea
            className="border border-gray-300 rounded-lg p-3 w-full mb-2 resize-none"
            value={description}
      ...
      <div className="flex gap-3 p-6 border-t justify-end">
        ...
        <button
          className="px-4 py-2 bg-red-600 text-white rounded-lg font-semibold shadow hover:scale-105 hover:shadow-lg transition-all"
